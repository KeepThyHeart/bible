...
const PERMISSION_DESCRIPTION_KEYS: Partial<Record<ExtensionPermission, string>> = {
  ...
  'search:provide': 'extensionConsent.permission.searchProvide',
  'display-mode:provide': 'extensionConsent.permission.displayModeProvide',
  'import:provide': 'extensionConsent.permission.importProvide',
  'ai:provide': 'extensionConsent.permission.aiProvide',
  'tts:provide': 'extensionConsent.permission.ttsProvide',
