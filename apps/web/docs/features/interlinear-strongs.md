...
- The original-language word and the transliteration are clickable too, opening the same dictionary entry as the `<sup>` Strong's chip. Leaving them inert would make the one thing a reader is most likely to click in an interlinear do nothing
