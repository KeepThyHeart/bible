import { LONG_NAMES, ENGLISH_BOOK_NAMES, MAX_CHAPTERS } from '@bible/core/browser';
...
/** Chapter count per book: one table in core, re-exported here so existing imports (and test mocks of this module) keep working. */
export { MAX_CHAPTERS };
